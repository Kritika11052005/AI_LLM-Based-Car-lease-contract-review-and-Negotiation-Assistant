...
export const API_ENDPOINTS = {
    ...
    // Negotiation
    NEGOTIATION: {
      ANALYZE: (id: string) => `/analyze-contract/${id}`,
      SCRIPT: (id: string) => `/negotiate-script/${id}`,
      ASK: (id: string) => `/negotiate-ask/${id}`,
      THREADS: "/negotiation-threads",
      MESSAGES: (threadId: string) => `/negotiation-threads/${threadId}/messages`,
    },
